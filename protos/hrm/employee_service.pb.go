...
type CreateEmployeeRequest struct {
	...
	ContactNumber    int32  `protobuf:"varint,6,opt,name=contact_number,json=contactNumber,proto3" json:"contact_number,omitempty"`
...
func (x *CreateEmployeeRequest) GetContactNumber() int32 {
	if x != nil {
...
func (x *SearchEmployeeRequest) Reset() {
	*x = SearchEmployeeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SearchEmployeeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchEmployeeRequest) ProtoMessage() {}

func (x *SearchEmployeeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_employee_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchEmployeeRequest.ProtoReflect.Descriptor instead.
func (*SearchEmployeeRequest) Descriptor() ([]byte, []int) {
	return file_employee_service_proto_rawDescGZIP(), []int{2}
}

func (x *SearchEmployeeRequest) GetFilter() *EmployeeFilter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *SearchEmployeeResponse) Reset() {
	*x = SearchEmployeeResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SearchEmployeeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SearchEmployeeResponse) ProtoMessage() {}

func (x *SearchEmployeeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_employee_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SearchEmployeeResponse.ProtoReflect.Descriptor instead.
func (*SearchEmployeeResponse) Descriptor() ([]byte, []int) {
	return file_employee_service_proto_rawDescGZIP(), []int{3}
}

func (x *SearchEmployeeResponse) GetEmployee() *Employee {
	if x != nil {
		return x.Employee
	}
	return nil
...
var file_employee_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcc, 0x02, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74,
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x11, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69,
	...
	,
	...
	0x65, 0x65, 0x32, 0x9b, 0x01, 0x0a, 0x0f, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x53,
	...
	0x65, 0x61, 0x72, 0x63, 0x68, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x12, 0x16, 0x2e,
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x45, 0x6d,
...
var file_employee_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_employee_service_proto_goTypes = []interface{}{
	...
	(*SearchEmployeeRequest)(nil),  // 2: SearchEmployeeRequest
	(*SearchEmployeeResponse)(nil), // 3: SearchEmployeeResponse
	(*EmployeeFilter)(nil),         // 4: EmployeeFilter
	(*Employee)(nil),               // 5: Employee
}
var file_employee_service_proto_depIdxs = []int32{
	4, // 0: SearchEmployeeRequest.filter:type_name -> EmployeeFilter
	5, // 1: SearchEmployeeResponse.employee:type_name -> Employee
	0, // 2: EmployeeService.CreateEmployee:input_type -> CreateEmployeeRequest
	2, // 3: EmployeeService.SearchEmployee:input_type -> SearchEmployeeRequest
	1, // 4: EmployeeService.CreateEmployee:output_type -> CreateEmployeeResponse
	3, // 5: EmployeeService.SearchEmployee:output_type -> SearchEmployeeResponse
...
func file_employee_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_employee_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SearchEmployeeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_employee_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SearchEmployeeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
