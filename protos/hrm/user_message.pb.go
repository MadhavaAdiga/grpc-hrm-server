...
type User struct {
	...
	ContactNumber int32                  `protobuf:"varint,8,opt,name=contact_number,json=contactNumber,proto3" json:"contact_number,omitempty"`
...
func (x *User) GetContactNumber() int32 {
	if x != nil {
...
var file_user_message_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05,
